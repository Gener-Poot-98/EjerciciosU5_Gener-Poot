...
while opcion == True:
    ...
    print("El archivo analizado es: "+str(filename)+"\n")
    print("-------------------------EJERCICIO 1--------------------------")
    ...
    print("Nombre: Gener Emmanuel Poot Can")
    print("Semestre y grupo: 5 Semestre | Grupo A"+"\n")
    res = input("Ingrese el comando [exit] para salir: ")
    if res == "[exit]":
        opcion = False
